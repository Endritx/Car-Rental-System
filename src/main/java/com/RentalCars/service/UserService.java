...
public class UserService implements UserDetailsService {
        ...
        public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
                com.RentalCars.domain.User user = userRepository.findByUsername(username)
        ...
        public com.RentalCars.domain.User editUser(Long id, UserInDto userInDto) {
                com.RentalCars.domain.User userEdited = userRepository.findById(id)
        ...
        public com.RentalCars.domain.User addRoleToUser(String username, String roleName) {
        ...
        public com.RentalCars.domain.User addCreditCardToUser(String username, CreditCardDto creditCardDto) {
